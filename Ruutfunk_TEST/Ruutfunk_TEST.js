...
function Write_texts(){
  ...
  TeX_text=createP("");
  TeX_text.position(200,(height-teksti_kasti_korgus)+17);
...
function Kontroll(){
  ...
  // PUNKT A
  if ( (((round_0(X_koordinaadid[0]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[0])) && (-1*((round_0(Y_koordinaadid[0]/4)*4)-(height-teksti_kasti_korgus)/2)/40) == func_Y_vaartus_1 ){
  ...
  // PUNKT B
  if ( (((round_0(X_koordinaadid[1]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[1])) && (-1*((round_0(Y_koordinaadid[1]/4)*4)-(height-teksti_kasti_korgus)/2)/40) == func_Y_vaartus_2 ){
  ...
  // PUNKT C
    if ( (((round_0(X_koordinaadid[2]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[2])) && (-1*((round_0(Y_koordinaadid[2]/4)*4)-(height-teksti_kasti_korgus)/2)/40) == func_Y_vaartus_3 ){
  ...
  // PUNKT D
    if ( (((round_0(X_koordinaadid[3]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[3])) && (-1*((round_0(Y_koordinaadid[3]/4)*4)-(height-teksti_kasti_korgus)/2)/40) == func_Y_vaartus_4 ){
  ...
  // PUNKT E
    if ( (((round_0(X_koordinaadid[4]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[4])) && (-1*((round_0(Y_koordinaadid[4]/4)*4)-(height-teksti_kasti_korgus)/2)/40) == func_Y_vaartus_5 ){
  ...
  // PUNKT F
    if ( (((round_0(X_koordinaadid[5]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[5])) && (-1*((round_0(Y_koordinaadid[5]/4)*4)-(height-teksti_kasti_korgus)/2)/40) == func_Y_vaartus_6 ){
  ...
  // PUNKT G
    if ( (((round_0(X_koordinaadid[6]/4)*4)-width/2)/40)==(round_1(X_ide_massiiv[6])) && (-1*((round_0(Y_koordinaadid[6]/4)*4)-(height-teksti_kasti_korgus)/2)/40) == func_Y_vaartus_7 ){
